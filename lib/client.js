...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS =
      ".dsl_root{box-sizing:border-box;font-size:13px;line-height:20px;color:var(--dsh-color-text,#e6e6e6)}" +
      ".dsl_head{margin-bottom:12px}" +
      ".dsl_title{font-size:15px;font-weight:600;margin:0 0 4px}" +
      ".dsl_sub{margin:0;opacity:.72;max-width:64ch}" +
      ...
      ".dsl_key{opacity:.6;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px}" +
      ".dsl_spacer{flex:1 1 auto}" +
      ".dsl_chip{border-radius:999px;padding:1px 8px;font-size:12px;border:1px solid currentColor;opacity:.85}" +
      ".dsl_chipOn{color:#3fb950}" +
      ".dsl_chipOff{opacity:.55}" +
      ".dsl_chipBusy{color:#d29922}" +
      ".dsl_actions{display:flex;gap:6px;flex-wrap:wrap}" +
      ".dsl_btn{font:inherit;padding:3px 10px;border-radius:6px;border:1px solid var(--dsh-color-border,rgba(128,128,128,.45));background:transparent;color:inherit;cursor:pointer}" +
      ".dsl_btn:hover:not(:disabled){border-color:currentColor}" +
      ".dsl_btn:disabled{opacity:.5;cursor:default}" +
      ".dsl_btnPrimary{background:var(--dsh-color-accent,#4c8dff);border-color:transparent;color:#fff}" +
      ".dsl_panel{margin-top:12px;border:1px solid var(--dsh-color-border,rgba(128,128,128,.32));border-radius:8px;padding:12px;display:flex;flex-direction:column;gap:8px}" +
      ".dsl_notice{display:flex;gap:8px;align-items:center;flex-wrap:wrap}" +
      ".dsl_notice a{color:inherit}" +
      ".dsl_code{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:14px;letter-spacing:.08em;padding:2px 8px;border-radius:6px;border:1px dashed var(--dsh-color-border,rgba(128,128,128,.5))}" +
      ".dsl_form{display:flex;gap:6px}" +
      ".dsl_input{font:inherit;flex:1 1 auto;min-width:0;padding:4px 8px;border-radius:6px;border:1px solid var(--dsh-color-border,rgba(128,128,128,.45));background:transparent;color:inherit}" +
      ".dsl_note{opacity:.7;margin:0;max-width:64ch;overflow-wrap:anywhere}" +
      ".dsl_orphans{margin-top:16px}" +
      ".dsl_others{margin-top:12px;display:flex;flex-direction:column;gap:8px;align-items:flex-start}" +
      ".dsl_failure{margin:8px 0 0;padding:8px 10px;border-radius:6px;border:1px solid #f85149;color:#f85149;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px;white-space:pre-wrap;overflow-wrap:anywhere;max-width:72ch}" +
      ".dsl_err{color:#f85149;margin:8px 0 0;overflow-wrap:anywhere;white-space:pre-wrap}";
    ...
    function LoginConsole(props) {
      ...
      if (attempt !== null) {
        ...
        children.push(react.createElement("div", { className: "dsl_panel", key: "attempt" }, panel));
      }
